  ...
  return (
    <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm md:p-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-slate-900">Trust System</h2>
          <p className="mt-1 text-sm text-slate-500">Test email, phone, profile, and score signals from one place.</p>
        </div>
        <button type="button" onClick={handleRecalculate} disabled={busy} className="rounded-full bg-[#d8e75f] px-4 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60">
          Recalculate
        </button>
      </div>
      ...
      <div className="mt-6 grid gap-4 xl:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button type="button" onClick={handleRequestEmail} disabled={busy} className="rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 disabled:opacity-60">
              Get code
            </button>
          </div>
          <div className="mt-4 flex gap-2">
            ...
            <button type="button" onClick={handleConfirmEmail} disabled={busy} className="rounded bg-[#f18f80] px-4 py-2 text-sm font-semibold text-white disabled:opacity-60">
              Confirm
            </button>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button type="button" onClick={handleRequestPhone} disabled={busy} className="rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 disabled:opacity-60">
              Get code
            </button>
          </div>
          <div className="mt-4 flex gap-2">
            ...
            <button type="button" onClick={handleConfirmPhone} disabled={busy} className="rounded bg-[#d8e75f] px-4 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60">
              Confirm
            </button>
          </div>
        </div>
